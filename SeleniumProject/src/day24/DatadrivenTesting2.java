...
public class DatadrivenTesting2 {
	...
	{
		FileInputStream file=new FileInputStream(".\\src\\com\\inetsolv\\excelfiles\\registration.xlsx");
		...
		FileOutputStream f=new FileOutputStream(".\\src\\com\\inetsolv\\excelfiles\\registration.xlsx");
		wb.write(f);
		wb.close();
